...
const RadiosModal = ({ isOpen, mode = 'edit', onClose, onSubmit, onRequestEdit, initialData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            payload.IdRadio = formData.IdRadio === '' ? null : Number(formData.IdRadio);
    ...
    return (
        <div className={styles.overlay} onClick={handleBackdropClick}>
            <div className={styles.modal} role="dialog" aria-modal="true" aria-labelledby="radio-modal-title">
                <div className={styles.header}>
                    <div className={styles.headerLeft}>
                        <span className={styles.iconWrap}>{TagIcon}</span>
                        <h3 id="radio-modal-title" className={styles.title}>
                            {isView ? 'Ver Radio' : initialData ? 'Editar Radio' : 'Nuevo Radio'}
                        </h3>
                    </div>
                    <button
                        type="button"
                    ...
                    <div className={styles.formGrid}>
                        {initialData && (
                            <div className={styles.formGroup}>
                                <label htmlFor="IdRadio">Código</label>
                                <input
                                    type="number"
                                    id="IdRadio"
